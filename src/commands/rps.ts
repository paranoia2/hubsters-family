...
export const data = new SlashCommandBuilder()
  .setName('rps')
  .setDescription('Камінь/Ножиці/Папір')
  .addStringOption(o=>o.setName('choice').setDescription('Твій вибір').setRequired(true).addChoices(
    {name:'Камінь', value:'rock'},
    {name:'Ножиці', value:'scissors'},
    {name:'Папір', value:'paper'}
  ));
